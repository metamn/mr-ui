    ...
    render() {
        ...
        return (
            <Container width={width} height={height}>
                <Logo>Lynx & Hare</Logo>
                <IntroText1>
                    Investing / trading is the highest stakes game in the world.
                </IntroText1>
                <IntroText2>
                    Your job as an investor is to pick players who can beat
                    others.
                </IntroText2>
                <Button>Select your player</Button>
                <Question>
                    <QuestionIntroText>
                        You must answer a question correctly before you may
                        choose to sign up.
                    </QuestionIntroText>
                    <QuestionBody>
                        <ol>
                            ...
                            <li>
                                ...
                                double your per-retirement income, and a 50%
                                chance that your income will be 20% less than
                                your per-retirement income
                            </li>
                            <li>
                                You will have no other source of income during
                                retirement, no chance of employment, and no
                                other family income ever in the future
                            </li>
